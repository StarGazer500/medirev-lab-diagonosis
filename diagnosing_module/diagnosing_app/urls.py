...
urlpatterns = [
    ...
    path('get-all-doctor/', GetAllDoctorView.as_view(),name="get-all-doctor"),
    ...
    path('get-all-lab-result/',GetAllLabResultView.as_view(),name="get-all-lab-result"),
    ...
    path('get-all-lab-reports/',GetAllLabReportView.as_view(),name="get-all-lab-reports")
